...
def hybrid_recommendation(user_id, user_weight=0.5, content_weight = 0.5):
    ...
    user_recommended_animes = get_user_recommendations(similar_users, user_pref, DF, SYNOPSIS_PATH, RATING_DF)
    ...
    for anime in user_recommended_anime_list:
        similar_animes = find_similar_animes("Steins;Gate", ANIME_WEIGHTS_PATH, ANIME2ANIME_ENCODED, ANIME2ANIME_DECODED, DF)
