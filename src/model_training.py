...
class ModelTraining():
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="PBbDoA6Fu6EHVA5sBH4SzAcEn",
            project_name="anime-mlops",
            workspace = 'anvesh4161'
        )
    ...
    def extract_weights(self, layer_name, model):
        try:
            ...
            logger.info(f"Extracted weights from layer {layer_name}")
            return weights
        except Exception as e:
            logger.error(str(e))
    ...
    def save_model_weights(self,model):
        try:
            ...
            logger.info(f"User and anime weights saved to {USER_WEIGHTS_PATH} and {ANIME_WEIGHTS_PATH} respectively")
